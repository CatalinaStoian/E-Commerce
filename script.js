...
// Creare functionalitate search

// document.getElementById('search-input').addEventListener('input', function(){
//     let searchTerm = this.value.toLowerCase();
//     let productDataTitles = productData[i].title; 

//     for(let i = 0; i < productDataTitles.length; i++){
//         let productName = productDataTitles[i].toLowerCase();
//         let productElement = document.getElementById('product-cards-container' + i); 
...
let addToCart = (product) => {
    ...
    console.log("cardProduct:", cartProducts);
...
const updateCartProducts = () => {
    ...
    for (let i = 0;i < cartProducts.length;i++) {
        ...
        productSection.classList.add("card-product-container");
// sectiunea stanga a produsului din sidebar
...
// creare local storage pentru cosul de cumparaturi
